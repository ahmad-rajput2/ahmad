...
return ' '.$jam.' :o You are Handsome (y) and Beautiful ;) But :p i am More than You :v 3:) => Buy Bot ╭∩╮（︶︿︶）╭∩╮AHMAD RAjpUT ^_^  => :v <3 Visit Bot Site: http://king-bike.jelastic.regruhosting.ru/  <3'.$nae.'
 '.$hr
}
